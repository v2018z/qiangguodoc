...
export default class AppUpdater {
  ...
  registerEvents() {
    autoUpdater.on('checking-for-update', this.checkForUpdate);

    autoUpdater.on('update-not-available', this.updateNotAvailable);

    autoUpdater.on('download-progress', this.downloadProgress);

    autoUpdater.on('update-download', this.updateDownload);
  }

  checkForUpdate() {
    console.log(console.log('Checking for update......'));
  }
  ...
  downloadProgress(progress: any) {
    const logMessage = progress.bytesPerSecond;
